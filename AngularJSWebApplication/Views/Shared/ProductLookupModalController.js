...
define(['application-configuration', 'productsService', 'alertsService', 'dataGridService'], function (app) {
    ...
    app.register.controller('productLookupModalController', ['$scope', '$rootScope', 'productsService', 'alertsService', 'dataGridService',
        function ($scope, $rootScope, productService, alertsService, dataGridService) {
            ...
            $scope.getProductsTypeAheadProductCode = function (productCode) {
                ...
                var productInquiry = $scope.createProductInquiryObject();
                productService.getProductsWithNoBlock(productInquiry, $scope.productInquiryCompleted, $scope.productInquiryError);
            }
